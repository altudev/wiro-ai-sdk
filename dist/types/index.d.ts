 ...
 */
export type TaskStatus = 'task_queue' | 'task_accept' | 'task_assign' | 'task_preprocess_start' | 'task_preprocess_end' | 'task_start' | 'task_output' | 'task_postprocess_start' | 'task_postprocess_end' | 'task_cancel';
/**
